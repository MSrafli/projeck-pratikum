...
<div class="card">
    ...
    <div class="card-body">
        <p>Selamat Datang <strong>rafli<i><?php echo $_SESSION['username'] ?></i></strong>,</p>
        <p>
            <strong>Materi ini mempelajari CRUD basic dengan <code>PHP + MYSQLi</code> </strong><br><br>Apa saja yang kita pelajari ?
        <ul>
